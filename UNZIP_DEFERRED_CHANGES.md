...
## Rollback
If you need to restore the original immediate-unzip behavior:
1. Remove the `Poll()` call from main.cpp loop
2. In `FileMgr.cpp` StartSdCard(), restore the original unzipping logic:
   ```cpp
