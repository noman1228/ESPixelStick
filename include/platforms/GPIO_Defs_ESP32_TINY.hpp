#pragma once
/*
* GPIO_Defs_ESP32_TINY.hpp - Output Management class
*
...
#define DEFAULT_RMT_1_GPIO     gpio_num_t::GPIO_NUM_NC
#define DEFAULT_RMT_2_GPIO     gpio_num_t::GPIO_NUM_NC
#define DEFAULT_RMT_3_GPIO     gpio_num_t::GPIO_NUM_NC
