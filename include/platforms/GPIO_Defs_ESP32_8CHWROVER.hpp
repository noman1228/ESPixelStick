...
#define STATUS_LED_1_GPIO       gpio_num_t::GPIO_NUM_2
#define STATUS_LED_2_GPIO       gpio_num_t::GPIO_NUM_3
#define INPUT_1_GPIO            gpio_num_t::GPIO_NUM_34
#define INPUT_2_GPIO            gpio_num_t::GPIO_NUM_35
