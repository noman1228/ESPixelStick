...
private:
    void initializePins() {
        ...
        configurePin(DEFAULT_RMT_4_GPIO , GPIO_MODE_OUTPUT, 0); // Set low
        configurePin(DEFAULT_RMT_5_GPIO , GPIO_MODE_OUTPUT, 0); // Set low
        // Configure input pins
        configurePin(BUTTON_GPIO1, GPIO_MODE_INPUT, 0);
